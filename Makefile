...
main: resources mongoose.o routes.o mouse.o network.o $(SRC_DIR)/main.c
	$(CC) $(CFLAGS) -o "$(OUT_DIR)/$(TARGET)" "$(OUT_DIR)/mongoose.o" "$(OUT_DIR)/routes.o" "$(OUT_DIR)/mouse.o" "$(OUT_DIR)/network.o"  "$(SRC_DIR)/main.c" -ldl -lpthread
